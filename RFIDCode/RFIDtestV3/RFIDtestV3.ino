...
const int correctOrder[NR_OF_READERS] = {1,2,3}; //The "correct" sequence, default starts at 1 and counts up. This is the value stored in the first bit of the 5th block on the NFC tags.
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect(clientId.c_str(), MQTT_USER, MQTT_PASSWORD)) {
      ...
      client.publish("Egypt/Library/", "hello world");
      // ... and resubscribe
