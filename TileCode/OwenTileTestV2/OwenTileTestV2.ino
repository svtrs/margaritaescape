  ...
  //Current working version
    ...
    Serial.println(readMux(i));
      ...
      while (readMux(i)<=3000){
        if (i==0) {
      lightPtile(1,9,12,155,155,155);
      }
        else if (i==1) {
      lightFtile(2,8,11,12,0,255,255);
      }
        else if (i==2) {
      lightFtile(3,7,10,11,0,0,255);
      }
        else if (i==3) {
      lightFtile(4,5,6,10,255,0,255);
      }
...
for (int i=(rowNum*8)-8; i<=(rowNum*8)-1; i++){
  ...
  void lightFtile (int R1, int R2, int R3, int R4, int R, int G, int B) {
    lightRow(R1,R,G,B);
    lightRow(R2,R,G,B);
    lightRow(R3,R,G,B);
    lightRow(R4,R,G,B);
    }
  void lightPtile (int R1, int R2, int R3, int R, int G, int B) {
    lightRow(R1,R,G,B);
    lightRow(R2,R,G,B);
    lightRow(R3,R,G,B);
    }
